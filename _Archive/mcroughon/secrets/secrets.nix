let
  systems = {
    ...
    doesRouter = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIBkSKtCYPkOhvDSTJ6Pe8TAN4hcn2+Lkj2zFwf7L1umG";
  };
  users = {
...
in
{
  "taylorHerculesClusterJoinToken.age".publicKeys = allUsers ++ [ systems.swordfish systems.h1 ];
  "taylorHerculesBinaryCaches.age".publicKeys = allUsers ++ [ systems.swordfish systems.h1 ];
