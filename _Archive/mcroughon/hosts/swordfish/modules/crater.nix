{ config, lib, pkgs, ... }:
let
  taylor = builtins.getFlake "github:taylor/nixpkgs/eb02ba188d55210d3478b924387edbbb04358f11";
  craterModule = "${taylor}/nixos/modules/services/web-apps/crater.nix";
  craterOverlay =
    (self: super: {
      crater = taylor.outputs.legacyPackages.${super.hostPlatform.system}.crater;
    });
...
in
{
  ...
  containers = {
    ...
    craterMatthew = makeCraterContainer 8040;
  };
}
